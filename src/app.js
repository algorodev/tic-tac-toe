...
DOM_BOARD_ITEMS.item1.addEventListener('click', () => {
	...
	if (isWinner) {
		...
		GAME_STATS.IS_BLUE_TURN ? ++GAME_STATS.PLAYER_ONE_SCORE : ++GAME_STATS.PLAYER_TWO_SCORE
	}
	if (isTie) {
		DOM_LAYOUT_ITEMS.board.classList.add('board--hidden')
		DOM_LAYOUT_ITEMS.tieBanner.classList.add('banner--visible')
	}
	DOM_LAYOUT_ITEMS.board.classList.remove(GAME_STATS.IS_BLUE_TURN ? 'board--player-x' : 'board--player-y')
	DOM_LAYOUT_ITEMS.board.classList.add(GAME_STATS.IS_BLUE_TURN ? 'board--player-y' : 'board--player-x')
	++GAME_STATS.TURN
...
DOM_LAYOUT_ITEMS.reset2.addEventListener('click', () => resetGame())
...
export const resetGame = () => {
	...
	DOM_LAYOUT_ITEMS.board.classList.remove('board--player-x', 'board--player-y')
	DOM_LAYOUT_ITEMS.board.classList.add('board--player-x')
...
export const refreshScoreboard = () => {
	DOM_LAYOUT_ITEMS.player1Score.textContent = GAME_STATS.PLAYER_ONE_SCORE + ''
	DOM_LAYOUT_ITEMS.player2Score.textContent = GAME_STATS.PLAYER_TWO_SCORE + ''
}
